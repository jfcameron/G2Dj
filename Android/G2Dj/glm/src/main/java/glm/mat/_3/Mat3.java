...
//        }
    ...
    public ByteBuffer toDbb(ByteBuffer res, int index) {
        ...
        res.putFloat(index + 3 * glm.Constants.FloatBYTES, m10);
        res.putFloat(index + 4 * glm.Constants.FloatBYTES, m11);
        res.putFloat(index + 5 * glm.Constants.FloatBYTES, m12);
        res.putFloat(index + 6 * glm.Constants.FloatBYTES, m20);
        res.putFloat(index + 7 * glm.Constants.FloatBYTES, m21);
        res.putFloat(index + 8 * glm.Constants.FloatBYTES, m22);
        return res;
    }
