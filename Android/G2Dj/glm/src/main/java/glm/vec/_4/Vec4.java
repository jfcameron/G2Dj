...
public class Vec4 extends colorSpace {
    ...
    public ByteBuffer toDbb(ByteBuffer bb, int index) {
        return bb
                .putFloat(index + 0 * glm.Constants.FloatBYTES, x)
                .putFloat(index + 1 * glm.Constants.FloatBYTES, y)
                .putFloat(index + 2 * glm.Constants.FloatBYTES, z)
                .putFloat(index + 3 * glm.Constants.FloatBYTES, w);
    }
