...
//    }
    ...
    public ByteBuffer toDbb(ByteBuffer bb, int index) {
        return bb
                .putInt(index + 0 * glm.Constants.FloatBYTES, (int) x.value)
                .putInt(index + 1 * glm.Constants.FloatBYTES, (int) y.value)
                .putInt(index + 2 * glm.Constants.FloatBYTES, (int) z.value)
                .putInt(index + 3 * glm.Constants.FloatBYTES, (int) w.value);
    }
